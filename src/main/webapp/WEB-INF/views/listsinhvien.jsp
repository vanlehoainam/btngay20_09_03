	...
	<table border="1">
		...
		<tbody>
			<c:forEach items="${sinhViens}" var="sinhVien">
				<tr>
					<td><c:out value="${sinhVien.idsv}" /></td>
					...
					<td><c:out value="${sinhVien.khoaHoc.idkh}" /></td>
					<td><a href="delete?sinhvienId=${sinhVien.idsv}">Delete</a>
						<a href="updatekhoahoc?sinhvienId=${sinhVien.idsv}">update</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
